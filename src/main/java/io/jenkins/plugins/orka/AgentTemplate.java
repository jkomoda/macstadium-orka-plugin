...
public class AgentTemplate implements Describable<AgentTemplate> {
    ...
    public String toString() {
        return "AgentTemplate [baseImage=" + baseImage + ", configName=" + configName + ", createNewVMConfig="
                ...
                + nodeProperties + ", numCPUs=" + numCPUs + ", memory=" + memory + ", tag=" + tag + ", tagRequired="
                + tagRequired + ", numExecutors=" + numExecutors + ", parent=" + parent + ", remoteFS="
                + remoteFS + ", retentionStrategy=" + retentionStrategy + ", verificationStrategy="
